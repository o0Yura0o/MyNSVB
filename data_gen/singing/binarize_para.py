...
class PopBuTFyENBinarizer(SingingBinarizer):
    ...
    def process_item(cls, item_name, wav_fn, spk_id, profwavfn, binarization_args):
        ...
        try:
            ...
            print(f"| Skip item ({e}). item_name: {item_name}, wav_fn: {wav_fn}, case1")
            return None
        except Exception as e:
            traceback.print_exc()
            print(f"| Skip item. item_name: {item_name}, wav_fn: {wav_fn},case2")
            return None
...
class PopBuTFyENSpkEMBinarizer(PopBuTFyENBinarizer):
    ...
    def process_item(cls, item_name, wav_fn, spk_id, profwavfn, item_names, binarization_args):
        ...
        try:
            # add itself
            print(hparams['spk_emb_data_dir'])
            ...
            traceback.print_exc()
            print(f"| Skip item. item_name: {item_name}, wav_fn: {wav_fn},case3")
            return None
